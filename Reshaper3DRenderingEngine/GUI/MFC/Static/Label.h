...
// CLabel window
#ifdef _HYEXT
class __declspec(dllexport) CLabel : public CStatic
#else
class __declspec(dllimport) CLabel : public CStatic
#endif
{
// Construction
public:
	...
	enum RadioType { NoRadio, RadioOff, RadioOn };

	inline const BOOL IsRadioOn() const { return m_RadioType == RadioOn; }
	...
	virtual CLabel& SetRadioType(RadioType iRadiotype);
